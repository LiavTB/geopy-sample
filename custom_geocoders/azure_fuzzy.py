...
__all__ = ("AzureMapsFuzzy", )


class AzureMapsFuzzy(TomTom):
    """Custom AzureMaps using fuzzy geocoder based on TomTom.

    Documentation at:
        https://docs.microsoft.com/en-us/azure/azure-maps/index
    """

    geocode_path = '/search/fuzzy/json'
    ...
    def __init__(
        ...
        :param str domain: Domain where the target Azure Maps service
            is hosted.
        """
        super(AzureMapsFuzzy, self).__init__(
    ...
    def _geocode_params(self, formatted_query):
        return {
            ...
            'maxFuzzyLevel': 4,
            'countrySet': 'IL',
            # 'typeahead': 'true', -- passed by geocode
            'language': 'he-IL'
